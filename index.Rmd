...
This package is meant to provide helpful functions for data analysis in educational statistics. There are two primary sets of functions currently implemented in the package. These include:
