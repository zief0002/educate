...
StatWatercolorDensity2 <- ggplot2::ggproto("StatWatercolorDensity", ggplot2::Stat,
                                          ...
                                          compute_group = function(data, scales, k = 1000, na.rm = TRUE,
                                            ...
                                            # if(multicolor){
                                            #
                                            #   # Get limits for empirical data
                                            #   emp_min = min(data$x, na.rm = TRUE)
                                            #   emp_max = max(data$x, na.rm = TRUE)
                                            #
                                            #   # Get empirical densities
                                            #   my_dens = data.frame(
                                            #     x = density(data$x, from = emp_min, to = emp_max, n = 128, na.rm = TRUE)$x,
                                            #     emp_dens = density(data$x, from = emp_min, to = emp_max, n = 128, na.rm = TRUE)$y
                                            #   )
                                            #
                                            ...
                                            #     dens.scaled = densities_within$dens.scaled,
                                            #     dens.scaled2 = densities_within$dens.scaled2
                                            #   )
                                            #
                                            # } else{
